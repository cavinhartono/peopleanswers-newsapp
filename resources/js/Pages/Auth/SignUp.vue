...
<template>
    ...
    <div class="min-h-screen flex justify-between gap-[50px] p-6">
        <div class="relative w-[600px] p-6 rounded-3xl bg-blue-500">
            ...
            <div class="py-6 h-full text-white">
        ...
        <div class="py-6" style="width: calc(100% - 600px)">
            <div>
                <h2 class="text-3xl font-bold text-black-500">Buat Akun</h2>
                <h2 class="text-lg font-medium text-black-500 opacity-75">
                    Jika Anda mempunyai akun?
                    <Link
                        :href="route('login')"
            ...
            <form @submit.prevent="submit" class="py-6">
                <div class="w-full">
                    <div class="w-full">
                        <label for="name" class="text-black-500">
                            Nama Lengkap
                        </label>
                        <input
                            type="text"
